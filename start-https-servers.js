...
console.log('🚀 Starting Museoo servers with HTTPS...\n');
console.log('📱 To access on your phone, use these URLs:');
console.log(`   Frontend (HTTPS): https://${localIP}:5173`);
console.log(`   Backend (HTTP):   http://${localIP}:3000`);
console.log('\n⚠️  Make sure your phone and computer are on the same WiFi network!');
console.log('🔐 HTTPS will allow camera access for QR scanning!\n');
...
setTimeout(() => {
  console.log('🎨 Starting frontend server with HTTPS...');
